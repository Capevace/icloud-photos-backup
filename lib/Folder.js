...
class Folder {
	 ...
	 */
	constructor(library, row, restrictToAlbum = null, parentFolder = null) {
		/**
		...
		/**
		 * The slugified name of the Folder.
		 * @type {string}
		 */
		this.slug = slugify(row.name);
		...
		if (row.children) {
			row.children.forEach(child => {
				...
				const folder = new Folder(this.library, child, restrictToAlbum, this);
